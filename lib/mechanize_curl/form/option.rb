...
class MechanizeCurl::Form::Option
  ...
  def initialize(node, select_list)
    ...
    @value    = MechanizeCurl::Util.html_unescape(node['value'] || node.inner_text)
  ...
  private
  def unselect_peers
    return unless MechanizeCurl::Form::SelectList === @select_list
