...
require 'mechanize_curl/file_saver'
require 'mechanize_curl/page'
require 'mechanize_curl/xml_file'
require 'mime/types'
...
#
# The default parser for unregistered content types is MechanizeCurl::File.
#
# The module MechanizeCurl::Parser provides basic functionality for any content
...
# MechanizeCurl::File.  For large files you should subclass MechanizeCurl::Download as
...
#   require 'csv'
#
#   class CSVParser < MechanizeCurl::File
#     attr_reader :csv
#
...
#
#   agent.pluggable_parser.default = MechanizeCurl::Download
#
# Now all unknown content types will be saved to disk and not loaded into
# memory.

class MechanizeCurl::PluggableParser
  ...
  def initialize
    @parsers = {
      CONTENT_TYPES[:html]  => MechanizeCurl::Page,
      CONTENT_TYPES[:xhtml] => MechanizeCurl::Page,
      CONTENT_TYPES[:wap]   => MechanizeCurl::Page,
      'image'               => MechanizeCurl::Image,
      'text/xml'            => MechanizeCurl::XmlFile,
      'application/xml'     => MechanizeCurl::XmlFile,
    }

    @default = MechanizeCurl::File
  end
