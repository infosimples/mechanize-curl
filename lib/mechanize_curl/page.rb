...
class MechanizeCurl::Page < MechanizeCurl::File
  extend Forwardable
  ...
  def initialize(uri=nil, response=nil, body=nil, code=nil, mech=nil)
    ...
    @encodings << MechanizeCurl::Util.detect_charset(body) if body
  ...
  def detected_encoding
    MechanizeCurl::Util.detect_charset(body)
  end
  ...
  def canonical_uri
    ...
    URI MechanizeCurl::Util.uri_escape href
  end
  ...
  def forms
    @forms ||= search('form').map do |html_form|
      form = MechanizeCurl::Form.new(html_form, @mech, self)
...
require 'mechanize_curl/headers'
require 'mechanize_curl/page/image'
require 'mechanize_curl/page/label'
require 'mechanize_curl/page/link'
require 'mechanize_curl/page/base'
require 'mechanize_curl/page/frame'
require 'mechanize_curl/page/meta_refresh'
