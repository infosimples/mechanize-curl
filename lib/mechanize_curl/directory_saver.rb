...
##
# Unlike MechanizeCurl::FileSaver, the directory saver places all downloaded files
...
#     MechanizeCurl::DirectorySaver.save_to 'images'

class MechanizeCurl::DirectorySaver < MechanizeCurl::Download
  ...
  # by save_to.  The filename is chosen by MechanizeCurl::Parser#extract_filename.
  ...
  def initialize uri = nil, response = nil, body_io = nil, code = nil
    ...
    raise MechanizeCurl::Error,
      ...
      'use MechanizeCurl::DirectorySaver.save_to ' \
